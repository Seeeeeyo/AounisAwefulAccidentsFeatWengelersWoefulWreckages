...
quarterly_sums <- aggregate(cbind(NUMBER_OF_PEDESTRIANS_INJURED, NUMBER_OF_CYCLIST_INJURED, NUMBER_OF_MOTORIST_INJURED, NUMBER_OF_PEDESTRIANS_KILLED, NUMBER_OF_CYCLIST_KILLED, NUMBER_OF_MOTORIST_KILLED) ~ QUARTER_YEAR, data = daily_sums, FUN = sum)
