...
################
  ...
  getPalette = colorRampPalette(brewer.pal(9, "Reds")) #choose other set to get another color scheme
...
ggplot(data=contributingFactorsDataframe, aes(x=causes, y=frequency, fill=causes))+
  geom_bar(stat = "identity")+
  ggtitle("Most common known causes of mortal collisions in NYC")+
