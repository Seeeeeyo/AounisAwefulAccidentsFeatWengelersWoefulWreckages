...
# Draw heat map
ggmap(map, extent = "device") +
  geom_density2d(data = collisionsComplete, aes(x = LONGITUDE, y = LATITUDE), size = 0.3) +stat_density2d(data = collisionsComplete, aes(x = LONGITUDE, y = LATITUDE, fill = ..level.., alpha = ..level..), size = 0.01, bins = 16, geom = "polygon") +scale_fill_gradient(low = "#ffd1d1", high = "#980000") + scale_alpha(range = c(0.2, 0.5), guide = FALSE)
```
